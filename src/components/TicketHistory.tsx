    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400">Atenciones registradas y firmas de conformidad</p>
        </div>
          ...
          {tickets.map(t => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3 border-b border-slate-800/80 pb-3">
                ...
                <span className="inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full font-bold bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 shrink-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                ...
                <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-slate-950/90 border border-slate-800/90 space-y-2 text-center">
                  ...
                  {t.url_firma ? (
                    ...
                    <span className="text-xs text-slate-500 italic py-4">Sin firma adjunta</span>
                  )}
                </div>
